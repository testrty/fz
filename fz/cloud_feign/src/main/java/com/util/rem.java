...
//            com.util.remoteCallt r=new com.util.remoteCallt();
//            r.login();
//            com.util.remoteCallt rec=new com.util.remoteCallt("192.168.2.136","phil","ph");
...
//
////                System.out.println(session.getStdout()+"这是是啥");
//
